    ...
    <div class="container">
        <div style="border: 2px solid #ccc; padding: 20px; border-radius: 10px;">
            ...
            <form action="#" method="post" style="margin-bottom: 20px;" onsubmit="return validateForm()">
                ...
                <button type="submit" style="width: 100%; padding: 10px; margin-top: 20px; background-color: #2F4F4F; color: white; border: none; border-radius: 5px; cursor: pointer;">Отправить</button>
            </form>
        </div>
        <?php if (!isset($_SESSION['userId'])): ?>
